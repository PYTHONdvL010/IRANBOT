...
<a href="{{url_for('dashboard')}}">🏠 <span>داشبورد</span></a><a href="{{url_for('users')}}">👥 <span>کاربران</span></a><a href="{{url_for('welcome')}}">👋 <span>خوش‌آمد</span></a><a href="{{url_for('mandatory')}}">📢 <span>عضویت اجباری</span></a><a href="{{url_for('finance')}}">💳 <span>مالی</span></a><a href="{{url_for('finance_report_web')}}">📊 <span>گزارش مالی</span></a><a href="{{url_for('panels')}}">🖥 <span>پنل‌ها</span></a><a href="{{url_for('products')}}">🛒 <span>محصولات</span></a><a href="{{url_for('orders')}}">📦 <span>سفارش‌ها</span></a><a href="{{url_for('free_tests')}}">🎁 <span>تست رایگان</span></a><a href="{{url_for('discount')}}">🏷 <span>تخفیف</span></a><a href="{{url_for('raffle')}}">🎟 <span>قرعه‌کشی</span></a><a href="{{url_for('backup')}}">💾 <span>پشتیبان‌گیری</span></a><a href="{{url_for('settings_web')}}">⚙️ <span>تنظیمات</span></a>
...
def dashboard():
    ...
    return page(b,users=users,products=products,orders=orders,paid=paid,pending=pending,panels=panels,revenue=revenue,recent=recent,bars=bars)
